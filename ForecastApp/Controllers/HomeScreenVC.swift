...
final class HomeScreenVC: UIViewController {
    ...
    private var resultlabelexit: Bool = false
    ...
    override func viewDidLoad() {
        ...
        resultTableView.selectionDelegate = self
...
extension HomeScreenVC: ResultTableControllerDelegate {
    func didSelectCity(_ forecast: Forecast) {
        searchController.isActive = false

        guard let weatherDetailVc = WeatherDetailVC(forecast: forecast, fiveDaysForecast: nil) else { return }
